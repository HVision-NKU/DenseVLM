...
COCO_STUFF_ADE20k_Thing204_STUFF112= [
    {'name': 'motorcycle', 'isthing': 1},
    {'name': 'boat', 'isthing': 1},
    {'name': 'fire hydrant', 'isthing': 1},
    {'name': 'stop sign', 'isthing': 1},
    {'name': 'parking meter', 'isthing': 1},
    {'name': 'bench', 'isthing': 1},
    {'name': 'bird', 'isthing': 1},
    {'name': 'cat', 'isthing': 1},
    {'name': 'sheep', 'isthing': 1},
    {'name': 'cow', 'isthing': 1},
    {'name': 'elephant', 'isthing': 1},
    {'name': 'bear', 'isthing': 1},
    {'name': 'zebra', 'isthing': 1},
    {'name': 'giraffe', 'isthing': 1},
    {'name': 'umbrella', 'isthing': 1},
    {'name': 'handbag', 'isthing': 1},
    {'name': 'tie', 'isthing': 1},
    {'name': 'suitcase', 'isthing': 1},
    {'name': 'frisbee', 'isthing': 1},
    {'name': 'skis', 'isthing': 1},
    {'name': 'snowboard', 'isthing': 1},
    {'name': 'sports ball', 'isthing': 1},
    {'name': 'kite', 'isthing': 1},
    {'name': 'baseball bat', 'isthing': 1},
    {'name': 'baseball glove', 'isthing': 1},
    {'name': 'skateboard', 'isthing': 1},
    {'name': 'surfboard', 'isthing': 1},
    {'name': 'tennis racket', 'isthing': 1},
    {'name': 'bottle', 'isthing': 1},
    {'name': 'wine glass', 'isthing': 1},
    {'name': 'cup, cups', 'isthing': 1},
    {'name': 'fork', 'isthing': 1},
    {'name': 'knife', 'isthing': 1},
    {'name': 'spoon', 'isthing': 1},
    {'name': 'bowl, bowls', 'isthing': 1},
    {'name': 'banana', 'isthing': 1},
    {'name': 'apple', 'isthing': 1},
    {'name': 'sandwich', 'isthing': 1},
    {'name': 'orange', 'isthing': 1},
    {'name': 'broccoli', 'isthing': 1},
    {'name': 'carrot', 'isthing': 1},
    {'name': 'hot dog', 'isthing': 1},
    {'name': 'pizza', 'isthing': 1},
    {'name': 'donut', 'isthing': 1},
    {'name': 'cake', 'isthing': 1},
    {'name': 'chair', 'isthing': 1},
    {'name': 'couch', 'isthing': 1},
    {'name': 'potted plant', 'isthing': 1},
    {'name': 'bed, beds', 'isthing': 1},
    {'name': 'dining table', 'isthing': 1},
    {'name': 'keyboard', 'isthing': 1},
    {'name': 'cell phone', 'isthing': 1},
    {'name': 'oven', 'isthing': 1},
    {'name': 'toaster', 'isthing': 1},
    {'name': 'sink', 'isthing': 1},
    {'name': 'book', 'isthing': 1},
    {'name': 'clock', 'isthing': 1},
    {'name': 'vase', 'isthing': 1},
    {'name': 'scissors', 'isthing': 1},
    {'name': 'teddy bear', 'isthing': 1},
    {'name': 'hair drier', 'isthing': 1},
    {'name': 'toothbrush', 'isthing': 1},
    {'name': 'cabinet', 'isthing': 1},
    {'name': 'clothes', 'isthing': 1},
    {'name': 'counter', 'isthing': 1},
    {'name': 'flower', 'isthing': 1},
    {'name': 'pillow', 'isthing': 1},
    {'name': 'shelf', 'isthing': 1},
    {'name': 'table, tables', 'isthing': 1},
    {'name': 'towel', 'isthing': 1},
    {'name': 'window ', 'isthing': 1},
    {'name': 'door', 'isthing': 1},
    {'name': 'painting, picture', 'isthing': 1},
    {'name': 'mirror', 'isthing': 1},
    {'name': 'armchair', 'isthing': 1},
    {'name': 'seat', 'isthing': 1},
    {'name': 'desk', 'isthing': 1},
    {'name': 'wardrobe, closet, press', 'isthing': 1},
    {'name': 'lamp', 'isthing': 1},
    {'name': 'tub', 'isthing': 1},
    {'name': 'cushion', 'isthing': 1},
    {'name': 'box', 'isthing': 1},
    {'name': 'column, pillar', 'isthing': 1},
    {'name': 'signboard, sign', 'isthing': 1},
    {'name': 'chest of drawers, chest, bureau, dresser', 'isthing': 1},
    {'name': 'refrigerator, icebox', 'isthing': 1},
    {'name': 'case, display case, showcase, vitrine', 'isthing': 1},
    {'name': 'pool table, billiard table, snooker table', 'isthing': 1},
    {'name': 'screen door, screen', 'isthing': 1},
    {'name': 'bookcase', 'isthing': 1},
    {'name': 'toilet, can, commode, crapper, pot, potty, stool, throne', 'isthing': 1},
    {'name': 'countertop', 'isthing': 1},
    {'name': 'palm, palm tree', 'isthing': 1},
    {'name': 'kitchen island', 'isthing': 1},
    {'name': 'swivel chair', 'isthing': 1},
    {'name': 'arcade machine', 'isthing': 1},
    {'name': 'awning, sunshade, sunblind', 'isthing': 1},
    {'name': 'street lamp', 'isthing': 1},
    {'name': 'plane', 'isthing': 1},
    {'name': 'pole', 'isthing': 1},
    {'name': 'bannister, banister, balustrade, balusters, handrail', 'isthing': 1},
    {'name': 'ottoman, pouf, pouffe, puff, hassock', 'isthing': 1},
    {'name': 'van', 'isthing': 1},
    {'name': 'ship', 'isthing': 1},
    {'name': 'fountain', 'isthing': 1},
    {'name': 'washer, automatic washer, washing machine', 'isthing': 1},
    {'name': 'plaything, toy', 'isthing': 1},
    {'name': 'stool', 'isthing': 1},
    {'name': 'barrel, barrels, cask', 'isthing': 1},
    {'name': 'minibike, motorbike', 'isthing': 1},
    {'name': 'ball', 'isthing': 1},
    {'name': 'food, solid food', 'isthing': 1},
    {'name': 'step, stair', 'isthing': 1},
    {'name': 'sculpture', 'isthing': 1},
    {'name': 'hood, exhaust hood', 'isthing': 1},
    {'name': 'sconce', 'isthing': 1},
    {'name': 'tray', 'isthing': 1},
    {'name': 'trash can', 'isthing': 1},
    {'name': 'fan', 'isthing': 1},
    {'name': 'plate', 'isthing': 1},
    {'name': 'radiator', 'isthing': 1},
    {'name': 'glass, drinking glass', 'isthing': 1},
    {'name': 'flag', 'isthing': 1},
    {'name': 'cupboard', 'isthing': 1},
    {'name': 'fruit', 'isthing': 1},
    {'name': 'cradle', 'isthing': 1},
    {'name': 'person, individual, someone, somebody, mortal, soul', 'isthing': 1},
    {'name': 'car, auto, automobile, machine, motorcar', 'isthing': 1},
    {'name': 'curtain, drape, drapery, mantle, pall', 'isthing': 1},
    {'name': 'sofa, couch, lounge', 'isthing': 1},
    {'name': 'fence, fencing', 'isthing': 1},
    {'name': 'bathtub, bathing tub, bath, tub', 'isthing': 1},
    {'name': 'railing, rail', 'isthing': 1},
    {'name': 'stairs, steps', 'isthing': 1},
    {'name': 'fireplace, hearth, open fireplace', 'isthing': 1},
    {'name': 'coffee table, cocktail table', 'isthing': 1},
    {'name': 'stove, kitchen stove, range, kitchen range, cooking stove', 'isthing': 1},
    {'name': 'streetlight, street lamp', 'isthing': 1},
    {'name': 'computer, computing machine, computing device, data processor, electronic computer, information processing system', 'isthing': 1},
    {'name': 'bus, autobus, coach, charabanc, double-decker, jitney, motorbus, motorcoach, omnibus, passenger vehicle', 'isthing': 1},
    {'name': 'light, light source', 'isthing': 1},
    {'name': 'television receiver, television, television set, tv, tv set, idiot box, boob tube, telly, goggle box', 'isthing': 1},
    {'name': 'truck, motortruck', 'isthing': 1},
    {'name': 'airplane, aeroplane, plane', 'isthing': 1},
    {'name': 'aircraft carrier, carrier, flattop, attack aircraft carrier', 'isthing': 1},
    {'name': 'animal, animate being, beast, brute, creature, fauna', 'isthing': 1},
    {'name': 'chandelier, pendant, pendent', 'isthing': 1},
    {'name': 'booth, cubicle, stall, kiosk', 'isthing': 1},
    {'name': 'bicycle, bike, wheel, wheels, cycle', 'isthing': 1},
    {'name': 'trade name, brand name, brand, marque', 'isthing': 1},
    {'name': 'traffic light, traffic signal, stoplight', 'isthing': 1},
    {'name': 'ashcan, trash can, garbage can, wastebin, ash bin, ash-bin, ashbin, dustbin, trash barrel, trash bin', 'isthing': 1},
    {'name': 'pot, flowerpot', 'isthing': 1},
    {'name': 'train, railroad train', 'isthing': 1},
    {'name': 'microwave, microwave oven', 'isthing': 1},
    {'name': 'dishwasher, dish washer, dishwashing machine', 'isthing': 1},
    {'name': 'screen, crt screen, silver screen, projection screen', 'isthing': 1},
    {'name': 'horse, equus caballus', 'isthing': 1},
    {'name': 'bag, handbag, pocketbook, purse, traveling bag, travelling bag, grip, suitcase', 'isthing': 1},
    {'name': 'bulletin board, notice board', 'isthing': 1},
    {'name': 'laptop, laptop computer', 'isthing': 1},
    {'name': 'bucket, buckets, pail', 'isthing': 1},
    {'name': 'monitor, monitors, monitoring device', 'isthing': 1},
    {'name': 'air conditioner, air conditioning', 'isthing': 1},
    {'name': 'backpack, back pack, knapsack, packsack, rucksack, haversack', 'isthing': 1},
    {'name': 'hat, chapeau, lid', 'isthing': 1},
    {'name': 'crane', 'isthing': 1},
    {'name': 'dog, domestic dog, canis familiaris', 'isthing': 1},
    {'name': 'cabin', 'isthing': 1},
    {'name': 'cart', 'isthing': 1},
    {'name': 'fish', 'isthing': 1},
    {'name': 'shoe', 'isthing': 1},
    {'name': 'basket, baskets, handbasket, basketball hoop, hoop', 'isthing': 1},
    {'name': 'bread, breads, breadstuff, staff of life', 'isthing': 1},
    {'name': 'motorboat', 'isthing': 1},
    {'name': 'guitar', 'isthing': 1},
    {'name': 'bulldozer', 'isthing': 1},
    {'name': 'pallet, pallets', 'isthing': 1},
    {'name': 'baby buggy, baby carriage, carriage, perambulator, pram, stroller, go-cart, pushchair, pusher', 'isthing': 1},
    {'name': 'canister, cannister, tin', 'isthing': 1},
    {'name': 'fireplug, fire hydrant, plug', 'isthing': 1},
    {'name': 'caravan', 'isthing': 1},
    {'name': 'brush', 'isthing': 1},
    {'name': 'alembic', 'isthing': 1},
    {'name': 'fire extinguisher, extinguisher, asphyxiator', 'isthing': 1},
    {'name': 'remote control, remote', 'isthing': 1},
    {'name': 'cue, cue stick, pool cue, pool stick', 'isthing': 1},
    {'name': 'chair desk', 'isthing': 1},
    {'name': 'alarm, warning device, alarm system, alarm clock', 'isthing': 1},
    {'name': 'duck', 'isthing': 1},
    {'name': 'ashtray', 'isthing': 1},
    {'name': 'camera, photographic camera', 'isthing': 1},
    {'name': 'canoe', 'isthing': 1},
    {'name': 'baggage carts', 'isthing': 1},
    {'name': 'carriage', 'isthing': 1},
    {'name': 'broom', 'isthing': 1},
    {'name': 'mouse, computer mouse', 'isthing': 1},
    {'name': 'balloon', 'isthing': 1},
    {'name': 'dvd, dvds, dvd player', 'isthing': 1},
    {'name': 'sprinkler', 'isthing': 1},
    {'name': 'andiron, firedog, dog, dog-iron', 'isthing': 1},
    {'name': 'dumbbell, dumbbells', 'isthing': 1},
    {'name': 'adding machine, totalizer, totaliser', 'isthing': 1},
    {'name': 'house', 'isthing': 1},
    {'name': 'banner', 'isthing': 0},
    {'name': 'branch', 'isthing': 0},
    {'name': 'building-other', 'isthing': 0},
    {'name': 'bush', 'isthing': 0},
    {'name': 'cage', 'isthing': 0},
    {'name': 'cardboard', 'isthing': 0},
    {'name': 'carpet', 'isthing': 0},
    {'name': 'ceiling-other', 'isthing': 0},
    {'name': 'ceiling-tile', 'isthing': 0},
    {'name': 'cloth', 'isthing': 0},
    {'name': 'clouds', 'isthing': 0},
    {'name': 'cupboard', 'isthing': 0},
    {'name': 'desk-stuff', 'isthing': 0},
    {'name': 'dirt', 'isthing': 0},
    {'name': 'door-stuff', 'isthing': 0},
    {'name': 'floor-marble', 'isthing': 0},
    {'name': 'floor-other', 'isthing': 0},
    {'name': 'floor-stone', 'isthing': 0},
    {'name': 'floor-tile', 'isthing': 0},
    {'name': 'floor-wood', 'isthing': 0},
    {'name': 'fog', 'isthing': 0},
    {'name': 'food-other', 'isthing': 0},
    {'name': 'fruit', 'isthing': 0},
    {'name': 'furniture-other', 'isthing': 0},
    {'name': 'grass', 'isthing': 0},
    {'name': 'gravel', 'isthing': 0},
    {'name': 'ground-other', 'isthing': 0},
    {'name': 'hill', 'isthing': 0},
    {'name': 'leaves', 'isthing': 0},
    {'name': 'mat', 'isthing': 0},
    {'name': 'metal', 'isthing': 0},
    {'name': 'mirror-stuff', 'isthing': 0},
    {'name': 'moss', 'isthing': 0},
    {'name': 'mud', 'isthing': 0},
    {'name': 'napkin', 'isthing': 0},
    {'name': 'net', 'isthing': 0},
    {'name': 'paper', 'isthing': 0},
    {'name': 'pavement', 'isthing': 0},
    {'name': 'plant-other', 'isthing': 0},
    {'name': 'plastic', 'isthing': 0},
    {'name': 'platform', 'isthing': 0},
    {'name': 'playingfield', 'isthing': 0},
    {'name': 'railroad', 'isthing': 0},
    {'name': 'river', 'isthing': 0},
    {'name': 'roof', 'isthing': 0},
    {'name': 'rug', 'isthing': 0},
    {'name': 'salad', 'isthing': 0},
    {'name': 'sand', 'isthing': 0},
    {'name': 'sea', 'isthing': 0},
    {'name': 'sky-other', 'isthing': 0},
    {'name': 'skyscraper', 'isthing': 0},
    {'name': 'snow', 'isthing': 0},
    {'name': 'solid-other', 'isthing': 0},
    {'name': 'stone', 'isthing': 0},
    {'name': 'straw', 'isthing': 0},
    {'name': 'structural-other', 'isthing': 0},
    {'name': 'tent', 'isthing': 0},
    {'name': 'textile-other', 'isthing': 0},
    {'name': 'tree', 'isthing': 0},
    {'name': 'vegetable', 'isthing': 0},
    {'name': 'wall-brick', 'isthing': 0},
    {'name': 'wall-concrete', 'isthing': 0},
    {'name': 'wall-other', 'isthing': 0},
    {'name': 'wall-panel', 'isthing': 0},
    {'name': 'wall-stone', 'isthing': 0},
    {'name': 'wall-tile', 'isthing': 0},
    {'name': 'wall-wood', 'isthing': 0},
    {'name': 'water-other', 'isthing': 0},
    {'name': 'waterdrops', 'isthing': 0},
    {'name': 'window-blind', 'isthing': 0},
    {'name': 'window-other', 'isthing': 0},
    {'name': 'wood', 'isthing': 0},
    {'name': 'wall', 'isthing': 0},
    {'name': 'building', 'isthing': 0},
    {'name': 'sky', 'isthing': 0},
    {'name': 'floor', 'isthing': 0},
    {'name': 'ceiling', 'isthing': 0},
    {'name': 'road, route', 'isthing': 0},
    {'name': 'sidewalk, pavement', 'isthing': 0},
    {'name': 'earth, ground', 'isthing': 0},
    {'name': 'mountain, mount', 'isthing': 0},
    {'name': 'plant', 'isthing': 0},
    {'name': 'water', 'isthing': 0},
    {'name': 'field', 'isthing': 0},
    {'name': 'rock, stone', 'isthing': 0},
    {'name': 'base, pedestal, stand', 'isthing': 0},
    {'name': 'grandstand, covered stand', 'isthing': 0},
    {'name': 'path', 'isthing': 0},
    {'name': 'runway', 'isthing': 0},
    {'name': 'stairway, staircase', 'isthing': 0},
    {'name': 'bridge, span', 'isthing': 0},
    {'name': 'blind, screen', 'isthing': 0},
    {'name': 'bar', 'isthing': 0},
    {'name': 'hovel, hut, hutch, shack, shanty', 'isthing': 0},
    {'name': 'tower', 'isthing': 0},
    {'name': 'dirt track', 'isthing': 0},
    {'name': 'land, ground, soil', 'isthing': 0},
    {'name': 'escalator, moving staircase, moving stairway', 'isthing': 0},
    {'name': 'buffet, counter, sideboard', 'isthing': 0},
    {'name': 'poster, posting, placard, notice, bill, card', 'isthing': 0},
    {'name': 'stage', 'isthing': 0},
    {'name': 'conveyer belt, conveyor belt, conveyer, conveyor, transporter', 'isthing': 0},
    {'name': 'canopy', 'isthing': 0},
    {'name': 'pool', 'isthing': 0},
    {'name': 'falls', 'isthing': 0},
    {'name': 'cradle', 'isthing': 0},
    {'name': 'tank, storage tank', 'isthing': 0},
    {'name': 'lake', 'isthing': 0},
    {'name': 'blanket, cover', 'isthing': 0},
    {'name': 'pier', 'isthing': 0},
    {'name': 'crt screen', 'isthing': 0},
    {'name': 'shower', 'isthing': 0}    
]


COCO_STUFF_ADE20k_847= [
    {'name': 'motorcycle', 'isthing': 1},
    {'name': 'boat', 'isthing': 1},
    {'name': 'fire hydrant', 'isthing': 1},
    {'name': 'stop sign', 'isthing': 1},
    ...
    {'name': 'blanket, cover', 'isthing': 0},
    {'name': 'shower', 'isthing': 0},
    {'name': 'building, edifice', 'isthing': 0},
    {'name': 'floor, flooring', 'isthing': 0},
    {'name': 'windowpane, window', 'isthing': 0},
    {'name': 'plant, flora, plant life', 'isthing': 0},
    {'name': 'rug, carpet, carpeting', 'isthing': 0},
    {'name': 'work surface', 'isthing': 0},
    {'name': 'cliff, drop, drop-off', 'isthing': 0},
    {'name': 'double door', 'isthing': 0},
    {'name': 'waterfall, falls', 'isthing': 0},
    {'name': 'controls', 'isthing': 0},
    {'name': 'embankment', 'isthing': 0},
    {'name': 'court', 'isthing': 0},
    {'name': 'apparel, wearing apparel, dress, clothes', 'isthing': 0},
    {'name': 'doorframe, doorcase', 'isthing': 0},
    {'name': 'pond', 'isthing': 0},
    {'name': 'gazebo', 'isthing': 0},
    {'name': 'board, plank', 'isthing': 0},
    {'name': 'eiderdown, duvet, continental quilt', 'isthing': 0},
    {'name': 'stall, stalls, stand, sales booth', 'isthing': 0},
    {'name': 'playground', 'isthing': 0},
    {'name': 'ice, water ice', 'isthing': 0},
    {'name': 'manhole', 'isthing': 0},
    {'name': 'tent, collapsible shelter', 'isthing': 0},
    {'name': 'beam', 'isthing': 0},
    {'name': 'ruins', 'isthing': 0},
    {'name': 'beacon, lighthouse, beacon light, pharos', 'isthing': 0},
    {'name': 'aqueduct', 'isthing': 0},
    {'name': 'container', 'isthing': 0},
    {'name': 'scaffolding, staging', 'isthing': 0},
    {'name': 'curb, curbing, kerb', 'isthing': 0},
    {'name': 'roller coaster', 'isthing': 0},
    {'name': 'catwalk', 'isthing': 0},
    {'name': 'central reservation', 'isthing': 0},
    {'name': 'carousel', 'isthing': 0},
    {'name': 'closet', 'isthing': 0},
    {'name': 'machine', 'isthing': 0},
    {'name': 'pier, wharf, wharfage, dock', 'isthing': 0},
    {'name': 'inflatable bounce game', 'isthing': 0},
    {'name': 'pitch', 'isthing': 0},
    {'name': 'arcade, colonnade', 'isthing': 0},
    {'name': 'hot tub', 'isthing': 0},
    {'name': 'helicopter', 'isthing': 0},
    {'name': 'partition, divider', 'isthing': 0},
    {'name': 'vineyard', 'isthing': 0},
    {'name': 'bullring', 'isthing': 0},
    {'name': 'footbridge, overcrossing, pedestrian bridge', 'isthing': 0},
    {'name': 'confessional booth', 'isthing': 0},
    {'name': 'trunk, tree trunk, bole', 'isthing': 0},
    {'name': 'forest', 'isthing': 0},
    {'name': 'elevator door', 'isthing': 0},
    {'name': 'instrument panel', 'isthing': 0},
    {'name': 'tapestry, tapis', 'isthing': 0},
    {'name': 'jacket', 'isthing': 0},
    {'name': 'gate', 'isthing': 0},
    {'name': 'telephone booth, phone booth, call box, telephone box, telephone kiosk', 'isthing': 0},
    {'name': 'spotlight, spot', 'isthing': 0},
    {'name': 'ring', 'isthing': 0},
    {'name': 'blackboard, chalkboard', 'isthing': 0},
    {'name': 'chest', 'isthing': 0},
    {'name': 'sand dune', 'isthing': 0},
    {'name': 'pipe, tube, pipage, piping', 'isthing': 0},
    {'name': 'vault', 'isthing': 0},
    {'name': 'table football', 'isthing': 0},
    {'name': 'cannon', 'isthing': 0},
    {'name': 'swimming pool, swimming bath, natatorium', 'isthing': 0},
    {'name': 'fluorescent, fluorescent fixture', 'isthing': 0},
    {'name': 'statue', 'isthing': 0},
    {'name': 'loudspeaker, speaker, speaker unit, loudspeaker system, speaker system', 'isthing': 0},
    {'name': 'exhibitor', 'isthing': 0},
    {'name': 'ladder', 'isthing': 0},
    {'name': 'carport', 'isthing': 0},
    {'name': 'dam', 'isthing': 0},
    {'name': 'pulpit', 'isthing': 0},
    {'name': 'skylight, fanlight', 'isthing': 0},
    {'name': 'water tower', 'isthing': 0},
    {'name': 'grill, grille, grillwork', 'isthing': 0},
    {'name': 'display board', 'isthing': 0},
    {'name': 'pane, pane of glass, window glass', 'isthing': 0},
    {'name': 'rubbish, trash, scrap', 'isthing': 0},
    {'name': 'ice rink', 'isthing': 0},
    {'name': 'vending machine', 'isthing': 0},
    {'name': 'telephone, phone, telephone set', 'isthing': 0},
    {'name': 'jar', 'isthing': 0},
    {'name': 'track, tracks', 'isthing': 0},
    {'name': 'magazine', 'isthing': 0},
    {'name': 'shutter', 'isthing': 0},
    {'name': 'banner, streamer', 'isthing': 0},
    {'name': 'landfill', 'isthing': 0},
    {'name': 'post', 'isthing': 0},
    {'name': 'altarpiece, reredos', 'isthing': 0},
    {'name': 'arch, archway', 'isthing': 0},
    {'name': 'table game', 'isthing': 0},
    {'name': 'document, written document, papers', 'isthing': 0},
    {'name': 'dome', 'isthing': 0},
    {'name': 'forecourt', 'isthing': 0},
    {'name': 'piano, pianoforte, forte-piano', 'isthing': 0},
    {'name': 'drawing', 'isthing': 0},
    {'name': 'ad, advertisement, advertizement, advertising, advertizing, advert', 'isthing': 0},
    {'name': 'amphitheater, amphitheatre, coliseum', 'isthing': 0},
    {'name': 'monument', 'isthing': 0},
    {'name': 'henhouse', 'isthing': 0},
    {'name': 'cockpit', 'isthing': 0},
    {'name': 'heater, warmer', 'isthing': 0},
    {'name': 'windmill, aerogenerator, wind generator', 'isthing': 0},
    {'name': 'elevator, lift', 'isthing': 0},
    {'name': 'decoration, ornament, ornamentation', 'isthing': 0},
    {'name': 'labyrinth', 'isthing': 0},
    {'name': 'text, textual matter', 'isthing': 0},
    {'name': 'printer', 'isthing': 0},
    {'name': 'mezzanine, first balcony', 'isthing': 0},
    {'name': 'mattress', 'isthing': 0},
    {'name': 'patio, terrace', 'isthing': 0},
    {'name': 'billboard, hoarding', 'isthing': 0},
    {'name': 'bus stop', 'isthing': 0},
    {'name': 'trouser, pant', 'isthing': 0},
    {'name': 'console table, console', 'isthing': 0},
    {'name': 'rack', 'isthing': 0},
    {'name': 'notebook', 'isthing': 0},
    {'name': 'shrine', 'isthing': 0},
    {'name': 'pantry', 'isthing': 0},
    {'name': 'steam shovel', 'isthing': 0},
    {'name': 'porch', 'isthing': 0},
    {'name': 'postbox, mailbox, letter box', 'isthing': 0},
    {'name': 'figurine, statuette', 'isthing': 0},
    {'name': 'recycling bin', 'isthing': 0},
    {'name': 'folding screen', 'isthing': 0},
    {'name': 'telescope', 'isthing': 0},
    {'name': 'deck chair, beach chair', 'isthing': 0},
    {'name': 'kennel', 'isthing': 0},
    {'name': 'coffee maker', 'isthing': 0},
    {'name': "altar, communion table, lord's table", 'isthing': 0},
    {'name': 'easel', 'isthing': 0},
    {'name': 'artificial golf green', 'isthing': 0},
    {'name': 'iceberg', 'isthing': 0},
    {'name': 'candlestick, candle holder', 'isthing': 0},
    {'name': 'shower stall, shower bath', 'isthing': 0},
    {'name': 'television stand', 'isthing': 0},
    {'name': 'wall socket, wall plug, electric outlet, electrical outlet, outlet, electric receptacle', 'isthing': 0},
    {'name': 'skeleton', 'isthing': 0},
    {'name': 'grand piano, grand', 'isthing': 0},
    {'name': 'candy, confect', 'isthing': 0},
    {'name': 'grille door', 'isthing': 0},
    {'name': 'pedestal, plinth, footstall', 'isthing': 0},
    {'name': 'jersey, t-shirt, tee shirt', 'isthing': 0},
    {'name': 'gravestone, headstone, tombstone, tombstones', 'isthing': 0},
    {'name': 'shanty, shanties', 'isthing': 0},
    {'name': 'structure', 'isthing': 0},
    {'name': 'rocking chair, rocker', 'isthing': 0},
    {'name': 'place mat', 'isthing': 0},
    {'name': 'tomb', 'isthing': 0},
    {'name': 'big top', 'isthing': 0},
    {'name': 'gas pump, gasoline pump, petrol pump, island dispenser', 'isthing': 0},
    {'name': 'locker, lockers', 'isthing': 0},
    {'name': 'finger', 'isthing': 0},
    {'name': 'bleachers', 'isthing': 0},
    {'name': 'ferris wheel', 'isthing': 0},
    {'name': 'hairdresser chair', 'isthing': 0},
    {'name': 'stands', 'isthing': 0},
    {'name': 'aquarium, fish tank, marine museum', 'isthing': 0},
    {'name': 'streetcar, tram, tramcar, trolley, trolley car', 'isthing': 0},
    {'name': 'napkin, table napkin, serviette', 'isthing': 0},
    {'name': 'dummy', 'isthing': 0},
    {'name': 'booklet, brochure, folder, leaflet, pamphlet', 'isthing': 0},
    {'name': 'sand trap', 'isthing': 0},
    {'name': 'shop, store', 'isthing': 0},
    {'name': 'table cloth', 'isthing': 0},
    {'name': 'service station', 'isthing': 0},
    {'name': 'coffin', 'isthing': 0},
    {'name': 'drawer', 'isthing': 0},
    {'name': 'slot machine, coin machine', 'isthing': 0},
    {'name': 'balcony', 'isthing': 0},
    {'name': 'volleyball court', 'isthing': 0},
    {'name': 'table tennis', 'isthing': 0},
    {'name': 'control table', 'isthing': 0},
    {'name': 'shirt', 'isthing': 0},
    {'name': 'merchandise, ware, product', 'isthing': 0},
    {'name': 'railway', 'isthing': 0},
    {'name': 'parterre', 'isthing': 0},
    {'name': 'chimney', 'isthing': 0},
    {'name': 'can, tin, tin can', 'isthing': 0},
    {'name': 'tanks', 'isthing': 0},
    {'name': 'fabric, cloth, material, textile', 'isthing': 0},
    {'name': 'alga, algae', 'isthing': 0},
    {'name': 'system', 'isthing': 0},
    {'name': 'map', 'isthing': 0},
    {'name': 'greenhouse', 'isthing': 0},
    {'name': 'mug', 'isthing': 0},
    {'name': 'barbecue', 'isthing': 0},
    {'name': 'trailer', 'isthing': 0},
    {'name': 'toilet tissue, toilet paper, bathroom tissue', 'isthing': 0},
    {'name': 'organ', 'isthing': 0},
    {'name': 'dishrag, dishcloth', 'isthing': 0},
    {'name': 'island', 'isthing': 0},
    {'name': 'trench', 'isthing': 0},
    {'name': 'steering wheel, wheel', 'isthing': 0},
    {'name': 'pitcher, ewer', 'isthing': 0},
    {'name': 'goal', 'isthing': 0},
    {'name': 'file cabinet', 'isthing': 0},
    {'name': 'newspaper, paper', 'isthing': 0},
    {'name': 'rope', 'isthing': 0},
    {'name': 'rubble', 'isthing': 0},
    {'name': 'scarf, scarfs', 'isthing': 0},
    {'name': 'cap', 'isthing': 0},
    {'name': 'control tower', 'isthing': 0},
    {'name': 'dashboard', 'isthing': 0},
    {'name': 'bandstand', 'isthing': 0},
    {'name': 'lectern', 'isthing': 0},
    {'name': 'switch, electric switch, electrical switch', 'isthing': 0},
    {'name': 'baseboard, mopboard, skirting board', 'isthing': 0},
    {'name': 'shower room', 'isthing': 0},
    {'name': 'smoke', 'isthing': 0},
    {'name': 'faucet, spigot', 'isthing': 0},
    {'name': 'saucepan', 'isthing': 0},
    {'name': 'shops', 'isthing': 0},
    {'name': 'crevasse', 'isthing': 0},
    {'name': 'gear', 'isthing': 0},
    {'name': 'candelabrum, candelabra', 'isthing': 0},
    {'name': 'sofa bed', 'isthing': 0},
    {'name': 'tunnel', 'isthing': 0},
    {'name': 'wire, conducting wire', 'isthing': 0},
    {'name': 'kettle, boiler', 'isthing': 0},
    {'name': 'bidet', 'isthing': 0},
    {'name': 'music stand', 'isthing': 0},
    {'name': 'ice hockey rink', 'isthing': 0},
    {'name': 'shelter', 'isthing': 0},
    {'name': 'weeds', 'isthing': 0},
    {'name': 'temple', 'isthing': 0},
    {'name': 'patty, cake', 'isthing': 0},
    {'name': 'ski slope', 'isthing': 0},
    {'name': 'panel', 'isthing': 0},
    {'name': 'wallet', 'isthing': 0},
    {'name': 'wheel', 'isthing': 0},
    {'name': 'towel rack, towel horse', 'isthing': 0},
    {'name': 'roundabout', 'isthing': 0},
    {'name': 'rod', 'isthing': 0},
    {'name': 'soap dispenser', 'isthing': 0},
    {'name': 'bell', 'isthing': 0},
    {'name': 'canvas', 'isthing': 0},
    {'name': 'box office, ticket office, ticket booth', 'isthing': 0},
    {'name': 'teacup', 'isthing': 0},
    {'name': 'trellis', 'isthing': 0},
    {'name': 'workbench', 'isthing': 0},
    {'name': 'valley, vale', 'isthing': 0},
    {'name': 'podium', 'isthing': 0},
    {'name': 'ramp', 'isthing': 0},
    {'name': 'tumble dryer', 'isthing': 0},
    {'name': 'gym shoe, sneaker, tennis shoe', 'isthing': 0},
    {'name': 'lab bench', 'isthing': 0},
    {'name': 'equipment', 'isthing': 0},
    {'name': 'rocky formation', 'isthing': 0},
    {'name': 'calendar', 'isthing': 0},
    {'name': 'check-in-desk', 'isthing': 0},
    {'name': 'ticket counter', 'isthing': 0},
    {'name': 'mill', 'isthing': 0},
    {'name': 'covered bridge', 'isthing': 0},
    {'name': 'bowling alley', 'isthing': 0},
    {'name': 'hanger, hangers', 'isthing': 0},
    {'name': 'excavator', 'isthing': 0},
    {'name': 'trestle', 'isthing': 0},
    {'name': 'revolving door', 'isthing': 0},
    {'name': 'blast furnace', 'isthing': 0},
    {'name': 'scale, weighing machine', 'isthing': 0},
    {'name': 'projector', 'isthing': 0},
    {'name': 'soap, soaps', 'isthing': 0},
    {'name': 'tractor', 'isthing': 0},
    {'name': 'stretcher', 'isthing': 0},
    {'name': 'frame', 'isthing': 0},
    {'name': 'grating', 'isthing': 0},
    {'name': 'candle, taper, wax light', 'isthing': 0},
    {'name': 'barrier', 'isthing': 0},
    {'name': 'cave', 'isthing': 0},
    {'name': 'puddle', 'isthing': 0},
    {'name': 'tarp', 'isthing': 0},
    {'name': 'price tag', 'isthing': 0},
    {'name': 'watchtower', 'isthing': 0},
    {'name': 'meter, meters', 'isthing': 0},
    {'name': 'light bulb, lightbulb, bulb, incandescent lamp, electric light, electric-light bulb', 'isthing': 0},
    {'name': 'hair dryer', 'isthing': 0},
    {'name': 'skirt', 'isthing': 0},
    {'name': 'viaduct', 'isthing': 0},
    {'name': 'paper towel', 'isthing': 0},
    {'name': 'coat', 'isthing': 0},
    {'name': 'sheet', 'isthing': 0},
    {'name': 'water wheel', 'isthing': 0},
    {'name': 'pottery, clayware', 'isthing': 0},
    {'name': 'magazine rack', 'isthing': 0},
    {'name': 'teapot', 'isthing': 0},
    {'name': 'microphone, mike', 'isthing': 0},
    {'name': 'support', 'isthing': 0},
    {'name': 'forklift', 'isthing': 0},
    {'name': 'canyon', 'isthing': 0},
    {'name': 'cash register, register', 'isthing': 0},
    {'name': 'leaf, leafage, foliage', 'isthing': 0},
    {'name': 'soap dish', 'isthing': 0},
    {'name': 'windshield, windscreen', 'isthing': 0},
    {'name': 'vent, venthole, vent-hole, blowhole', 'isthing': 0},
    {'name': 'shovel', 'isthing': 0},
    {'name': 'eaves', 'isthing': 0},
    {'name': 'antenna, aerial, transmitting aerial', 'isthing': 0},
    {'name': 'shipyard', 'isthing': 0},
    {'name': 'hen, biddy', 'isthing': 0},
    {'name': 'traffic cone', 'isthing': 0},
    {'name': 'washing machines', 'isthing': 0},
    {'name': 'truck crane', 'isthing': 0},
    {'name': 'cd, cds', 'isthing': 0},
    {'name': 'niche', 'isthing': 0},
    {'name': 'scoreboard', 'isthing': 0},
    {'name': 'briefcase', 'isthing': 0},
    {'name': 'boot', 'isthing': 0},
    {'name': 'sweater, jumper', 'isthing': 0},
    {'name': 'hay', 'isthing': 0},
    {'name': 'pack', 'isthing': 0},
    {'name': 'bottle rack', 'isthing': 0},
    {'name': 'glacier', 'isthing': 0},
    {'name': 'pergola', 'isthing': 0},
    {'name': 'building materials', 'isthing': 0},
    {'name': 'television camera', 'isthing': 0},
    {'name': 'first floor', 'isthing': 0},
    {'name': 'rifle', 'isthing': 0},
    {'name': 'tennis table', 'isthing': 0},
    {'name': 'stadium', 'isthing': 0},
    {'name': 'safety belt', 'isthing': 0},
    {'name': 'cover', 'isthing': 0},
    {'name': 'dish rack', 'isthing': 0},
    {'name': 'synthesizer', 'isthing': 0},
    {'name': 'pumpkin', 'isthing': 0},
    {'name': 'gutter', 'isthing': 0},
    {'name': 'fruit stand', 'isthing': 0},
    {'name': 'ice floe, floe', 'isthing': 0},
    {'name': 'handle, grip, handgrip, hold', 'isthing': 0},
    {'name': 'wheelchair', 'isthing': 0},
    {'name': 'mousepad, mouse mat', 'isthing': 0},
    {'name': 'diploma', 'isthing': 0},
    {'name': 'fairground ride', 'isthing': 0},
    {'name': 'radio', 'isthing': 0},
    {'name': 'hotplate', 'isthing': 0},
    {'name': 'junk', 'isthing': 0},
    {'name': 'wheelbarrow', 'isthing': 0},
    {'name': 'stream', 'isthing': 0},
    {'name': 'toll plaza', 'isthing': 0},
    {'name': 'punching bag', 'isthing': 0},
    {'name': 'trough', 'isthing': 0},
    {'name': 'throne', 'isthing': 0},
    {'name': 'weighbridge', 'isthing': 0},
    {'name': 'extractor fan', 'isthing': 0},
    {'name': 'hanging clothes', 'isthing': 0},
    {'name': 'dish, dish aerial, dish antenna, saucer', 'isthing': 0},
    {'name': 'ski lift', 'isthing': 0},
    {'name': 'chain', 'isthing': 0},
    {'name': 'garage', 'isthing': 0},
    {'name': 'mechanical shovel', 'isthing': 0},
    {'name': 'wine rack', 'isthing': 0},
    {'name': 'tramway', 'isthing': 0},
    {'name': 'treadmill', 'isthing': 0},
    {'name': 'menu', 'isthing': 0},
    {'name': 'block', 'isthing': 0},
    {'name': 'well', 'isthing': 0},
    {'name': 'witness stand', 'isthing': 0},
    {'name': 'casserole', 'isthing': 0},
    {'name': 'frying pan', 'isthing': 0},
    {'name': 'desk organizer', 'isthing': 0},
    {'name': 'mast', 'isthing': 0},
    {'name': 'spectacles, specs, eyeglasses, glasses', 'isthing': 0},
    {'name': 'service elevator', 'isthing': 0},
    {'name': 'dollhouse', 'isthing': 0},
    {'name': 'hammock', 'isthing': 0},
    {'name': 'clothes hanging', 'isthing': 0},
    {'name': 'photocopier', 'isthing': 0},
    {'name': 'notepad', 'isthing': 0},
    {'name': 'golf cart', 'isthing': 0},
    {'name': 'footpath', 'isthing': 0},
    {'name': 'cross', 'isthing': 0},
    {'name': 'baptismal font', 'isthing': 0},
    {'name': 'boiler', 'isthing': 0},
    {'name': 'skip', 'isthing': 0},
    {'name': 'rotisserie', 'isthing': 0},
    {'name': 'water mill', 'isthing': 0},
    {'name': 'helmet', 'isthing': 0},
    {'name': 'cover curtain', 'isthing': 0},
    {'name': 'brick', 'isthing': 0},
    {'name': 'table runner', 'isthing': 0},
    {'name': 'street box', 'isthing': 0},
    {'name': 'stick, sticks', 'isthing': 0},
    {'name': 'cells', 'isthing': 0},
    {'name': 'urinal', 'isthing': 0},
    {'name': 'centerpiece', 'isthing': 0},
    {'name': 'portable fridge', 'isthing': 0},
    {'name': 'golf club', 'isthing': 0},
    {'name': 'skirting board', 'isthing': 0},
    {'name': 'water cooler', 'isthing': 0},
    {'name': 'clipboard', 'isthing': 0},
    {'name': 'pigeonhole', 'isthing': 0},
    {'name': 'chips', 'isthing': 0},
    {'name': 'food processor', 'isthing': 0},
    {'name': 'post box', 'isthing': 0},
    {'name': 'lid', 'isthing': 0},
    {'name': 'drum', 'isthing': 0},
    {'name': 'blender', 'isthing': 0},
    {'name': 'cave entrance', 'isthing': 0},
    {'name': 'dental chair', 'isthing': 0},
    {'name': 'obelisk', 'isthing': 0},
    {'name': 'mobile', 'isthing': 0},
    {'name': 'pool ball, pool balls', 'isthing': 0},
    {'name': 'cue rack', 'isthing': 0},
    {'name': 'shore', 'isthing': 0},
    {'name': 'paper filer', 'isthing': 0},
    {'name': 'bicycle rack', 'isthing': 0},
    {'name': 'coat rack', 'isthing': 0},
    {'name': 'garland', 'isthing': 0},
    {'name': 'sports bag', 'isthing': 0},
    {'name': 'fish tank', 'isthing': 0},
    {'name': 'towel dispenser', 'isthing': 0},
    {'name': 'brochure', 'isthing': 0},
    {'name': 'plaque', 'isthing': 0},
    {'name': 'stringer', 'isthing': 0},
    {'name': 'iron', 'isthing': 0},
    {'name': 'flag pole', 'isthing': 0},
    {'name': 'toilet brush', 'isthing': 0},
    {'name': 'book stand', 'isthing': 0},
    {'name': 'water faucet, water tap, tap, hydrant', 'isthing': 0},
    {'name': 'ticket office', 'isthing': 0},
    {'name': 'ice bucket', 'isthing': 0},
    {'name': 'carapace, shell, cuticle, shield', 'isthing': 0},
    {'name': 'tureen', 'isthing': 0},
    {'name': 'folders', 'isthing': 0},
    {'name': 'chess', 'isthing': 0},
    {'name': 'root', 'isthing': 0},
    {'name': 'sewing machine', 'isthing': 0},
    {'name': 'model', 'isthing': 0},
    {'name': 'pen', 'isthing': 0},
    {'name': 'violin', 'isthing': 0},
    {'name': 'sweatshirt, sweatshirts', 'isthing': 0},
    {'name': 'recycling materials', 'isthing': 0},
    {'name': 'mitten', 'isthing': 0},
    {'name': 'chopping board, cutting board', 'isthing': 0},
    {'name': 'mask', 'isthing': 0},
    {'name': 'log', 'isthing': 0},
    {'name': 'hole', 'isthing': 0},
    {'name': 'target', 'isthing': 0},
    {'name': 'trash bag, trash bags', 'isthing': 0},
    {'name': 'chalk', 'isthing': 0},
    {'name': 'score', 'isthing': 0},
    {'name': 'hair spray', 'isthing': 0},
    {'name': 'roll', 'isthing': 0},
    {'name': 'runner', 'isthing': 0},
    {'name': 'engine', 'isthing': 0},
    {'name': 'inflatable glove', 'isthing': 0},
    {'name': 'games', 'isthing': 0},
    {'name': 'coop', 'isthing': 0},
    {'name': 'rocking horse', 'isthing': 0},
    {'name': 'bread rolls', 'isthing': 0},
    {'name': 'shawl', 'isthing': 0},
    {'name': 'watering can', 'isthing': 0},
    {'name': 'spotlights', 'isthing': 0},
    {'name': 'post-it', 'isthing': 0},
    {'name': 'security camera', 'isthing': 0},
    {'name': 'runner cloth', 'isthing': 0},
    {'name': 'lock', 'isthing': 0},
    {'name': 'side', 'isthing': 0},
    {'name': 'roulette', 'isthing': 0},
    {'name': 'bone', 'isthing': 0},
    {'name': 'cutlery', 'isthing': 0},
    {'name': 'spice rack', 'isthing': 0},
    {'name': 'plant pots', 'isthing': 0},
    {'name': 'towel ring', 'isthing': 0},
    {'name': 'bread box', 'isthing': 0},
    {'name': 'video, videos', 'isthing': 0},
    {'name': 'funfair', 'isthing': 0},
    {'name': 'tripod', 'isthing': 0},
    {'name': 'ironing board', 'isthing': 0},
    {'name': 'skimmer', 'isthing': 0},
    {'name': 'hollow', 'isthing': 0},
    {'name': 'scratching post', 'isthing': 0},
    {'name': 'tricycle', 'isthing': 0},
    {'name': 'file box', 'isthing': 0},
    {'name': 'mountain pass', 'isthing': 0},
    {'name': 'cooker', 'isthing': 0},
    {'name': 'card game, cards', 'isthing': 0},
    {'name': 'golf bag', 'isthing': 0},
    {'name': 'towel paper', 'isthing': 0},
    {'name': 'chaise lounge', 'isthing': 0},
    {'name': 'sun', 'isthing': 0},
    {'name': 'toilet paper holder', 'isthing': 0},
    {'name': 'rake', 'isthing': 0},
    {'name': 'key', 'isthing': 0},
    {'name': 'umbrella stand', 'isthing': 0},
    {'name': 'dartboard', 'isthing': 0},
    {'name': 'transformer', 'isthing': 0},
    {'name': 'fireplace utensils', 'isthing': 0},
    {'name': 'cellular telephone, cellular phone, cellphone, cell, mobile phone', 'isthing': 0},
    {'name': 'tallboy', 'isthing': 0},
    {'name': 'stapler', 'isthing': 0},
    {'name': 'sauna', 'isthing': 0},
    {'name': 'test tube', 'isthing': 0},
    {'name': 'palette', 'isthing': 0},
    {'name': 'shopping carts', 'isthing': 0},
    {'name': 'tools', 'isthing': 0},
    {'name': 'push button, push, button', 'isthing': 0},
    {'name': 'star', 'isthing': 0},
    {'name': 'roof rack', 'isthing': 0},
    {'name': 'barbed wire', 'isthing': 0},
    {'name': 'spray', 'isthing': 0},
    {'name': 'ear', 'isthing': 0},
    {'name': 'sponge', 'isthing': 0},
    {'name': 'racket', 'isthing': 0},
    {'name': 'tins', 'isthing': 0},
    {'name': 'eyeglasses', 'isthing': 0},
    {'name': 'file', 'isthing': 0},
    {'name': 'sugar bowl', 'isthing': 0},
    {'name': 'flip flop', 'isthing': 0},
    {'name': 'headstones', 'isthing': 0},
    {'name': 'laptop bag', 'isthing': 0},
    {'name': 'leash', 'isthing': 0},
    {'name': 'climbing frame', 'isthing': 0},
    {'name': 'suit hanger', 'isthing': 0},
    {'name': 'floor spotlight', 'isthing': 0},
    {'name': 'plate rack', 'isthing': 0},
    {'name': 'sewer', 'isthing': 0},
    {'name': 'hard drive', 'isthing': 0},
    {'name': 'tools box', 'isthing': 0},
    {'name': 'necklace', 'isthing': 0},
    {'name': 'bulbs', 'isthing': 0},
    {'name': 'steel industry', 'isthing': 0},
    {'name': 'club', 'isthing': 0},
    {'name': 'jack', 'isthing': 0},
    {'name': 'door bars', 'isthing': 0},
    {'name': 'control panel, instrument panel, control board, board, panel', 'isthing': 0},
    {'name': 'hairbrush', 'isthing': 0},
    {'name': 'napkin holder', 'isthing': 0},
    {'name': 'office', 'isthing': 0},
    {'name': 'smoke detector', 'isthing': 0},
    {'name': 'utensils', 'isthing': 0},
    {'name': 'apron', 'isthing': 0},
    {'name': 'terminal', 'isthing': 0},
    {'name': 'grinder', 'isthing': 0},
    {'name': 'entry phone', 'isthing': 0},
    {'name': 'newspaper stand', 'isthing': 0},
    {'name': 'pepper shaker', 'isthing': 0},
    {'name': 'onions', 'isthing': 0},
    {'name': 'central processing unit, cpu, c p u , central processor, processor, mainframe', 'isthing': 0},
    {'name': 'tape', 'isthing': 0},
    {'name': 'bat', 'isthing': 0},
    {'name': 'coaster', 'isthing': 0},
    {'name': 'calculator', 'isthing': 0},
    {'name': 'potatoes', 'isthing': 0},
    {'name': 'luggage rack', 'isthing': 0},
    {'name': 'salt', 'isthing': 0},
    {'name': 'street number', 'isthing': 0},
    {'name': 'viewpoint', 'isthing': 0},
    {'name': 'sword', 'isthing': 0},
    {'name': 'rowing machine', 'isthing': 0},
    {'name': 'plug', 'isthing': 0},
    {'name': 'pepper', 'isthing': 0},
    {'name': 'tongs', 'isthing': 0},
    {'name': 'bonfire', 'isthing': 0},
    {'name': 'dog dish', 'isthing': 0},
    {'name': 'belt', 'isthing': 0},
    {'name': 'videocassette recorder, vcr', 'isthing': 0},
    {'name': 'hook', 'isthing': 0},
    {'name': 'envelopes', 'isthing': 0},
    {'name': 'shower faucet', 'isthing': 0},
    {'name': 'watch', 'isthing': 0},
    {'name': 'padlock', 'isthing': 0},
    {'name': 'swimming pool ladder', 'isthing': 0},
    {'name': 'spanners', 'isthing': 0},
    {'name': 'gravy boat', 'isthing': 0},
    {'name': 'notice board', 'isthing': 0},
    {'name': 'fire alarm', 'isthing': 0},
    {'name': 'ladle', 'isthing': 0},
    {'name': 'stethoscope', 'isthing': 0},
    {'name': 'rocket', 'isthing': 0},
    {'name': 'funnel', 'isthing': 0},
    {'name': 'bowling pins', 'isthing': 0},
    {'name': 'valve', 'isthing': 0},
    {'name': 'thermometer', 'isthing': 0},
    {'name': 'spice jar', 'isthing': 0},
    {'name': 'night light', 'isthing': 0},
    {'name': 'games table', 'isthing': 0},
    {'name': 'slotted spoon', 'isthing': 0},
    {'name': 'reel', 'isthing': 0},
    {'name': 'scourer', 'isthing': 0},
    {'name': 'sleeping robe', 'isthing': 0},
    {'name': 'desk mat', 'isthing': 0},
    {'name': 'hammer', 'isthing': 0},
    {'name': 'typewriter', 'isthing': 0},
    {'name': 'shaker', 'isthing': 0},
    {'name': 'cheese dish', 'isthing': 0},
    {'name': 'sea star', 'isthing': 0},
    {'name': 'racquet', 'isthing': 0},
    {'name': 'butane gas cylinder', 'isthing': 0},
    {'name': 'paper weight', 'isthing': 0},
    {'name': 'shaving brush', 'isthing': 0},
    {'name': 'sunglasses', 'isthing': 0},
    {'name': 'gear shift', 'isthing': 0},
    {'name': 'towel rail', 'isthing': 0}
]

COCO_STUFF_ADE20k_150 = [
    {'name': 'person', 'isthing': 1},
    {'name': 'bicycle', 'isthing': 1},
    {'name': 'car', 'isthing': 1},
    {'name': 'motorcycle', 'isthing': 1},
    {'name': 'airplane', 'isthing': 1},
    {'name': 'bus', 'isthing': 1},
    {'name': 'train', 'isthing': 1},
    {'name': 'truck', 'isthing': 1},
    {'name': 'boat', 'isthing': 1},
    {'name': 'traffic light', 'isthing': 1},
    {'name': 'fire hydrant', 'isthing': 1},
    {'name': 'stop sign', 'isthing': 1},
    {'name': 'parking meter', 'isthing': 1},
    {'name': 'bench', 'isthing': 1},
    ...
    {'name': 'dining table', 'isthing': 1},
    {'name': 'tv', 'isthing': 1},
    {'name': 'laptop', 'isthing': 1},
    {'name': 'mouse', 'isthing': 1},
    {'name': 'remote', 'isthing': 1},
    {'name': 'keyboard', 'isthing': 1},
    {'name': 'cell phone', 'isthing': 1},
    {'name': 'microwave', 'isthing': 1},
    {'name': 'oven', 'isthing': 1},
    {'name': 'toaster', 'isthing': 1},
    {'name': 'sink', 'isthing': 1},
    {'name': 'book', 'isthing': 1},
    ...
    {'name': 'clothes', 'isthing': 1},
    {'name': 'counter', 'isthing': 1},
    {'name': 'curtain', 'isthing': 1},
    {'name': 'fence', 'isthing': 1},
    {'name': 'flower', 'isthing': 1},
    {'name': 'light', 'isthing': 1},
    {'name': 'pillow', 'isthing': 1},
    {'name': 'shelf', 'isthing': 1},
    {'name': 'stairs', 'isthing': 1},
    {'name': 'table', 'isthing': 1},
    {'name': 'towel', 'isthing': 1},
    {'name': 'window ', 'isthing': 1},
    {'name': 'door', 'isthing': 1},
    {'name': 'painting, picture', 'isthing': 1},
    ...
    {'name': 'signboard, sign', 'isthing': 1},
    {'name': 'chest of drawers, chest, bureau, dresser', 'isthing': 1},
    {'name': 'fireplace', 'isthing': 1},
    {'name': 'refrigerator, icebox', 'isthing': 1},
    {'name': 'case, display case, showcase, vitrine', 'isthing': 1},
    {'name': 'pool table, billiard table, snooker table', 'isthing': 1},
    {'name': 'screen door, screen', 'isthing': 1},
    {'name': 'bookcase', 'isthing': 1},
    {'name': 'coffee table', 'isthing': 1},
    {'name': 'toilet, can, commode, crapper, pot, potty, stool, throne', 'isthing': 1},
    {'name': 'countertop', 'isthing': 1},
    {'name': 'stove', 'isthing': 1},
    {'name': 'palm, palm tree', 'isthing': 1},
    {'name': 'kitchen island', 'isthing': 1},
    {'name': 'computer', 'isthing': 1},
    {'name': 'swivel chair', 'isthing': 1},
    {'name': 'arcade machine', 'isthing': 1},
    {'name': 'chandelier', 'isthing': 1},
    {'name': 'awning, sunshade, sunblind', 'isthing': 1},
    {'name': 'street lamp', 'isthing': 1},
    {'name': 'booth', 'isthing': 1},
    {'name': 'plane', 'isthing': 1},
    {'name': 'pole', 'isthing': 1},
    {'name': 'bannister, banister, balustrade, balusters, handrail', 'isthing': 1},
    {'name': 'ottoman, pouf, pouffe, puff, hassock', 'isthing': 1},
    ...
    {'name': 'plaything, toy', 'isthing': 1},
    {'name': 'stool', 'isthing': 1},
    {'name': 'barrel, cask', 'isthing': 1},
    {'name': 'basket, handbasket', 'isthing': 1},
    {'name': 'bag', 'isthing': 1},
    {'name': 'minibike, motorbike', 'isthing': 1},
    {'name': 'ball', 'isthing': 1},
    {'name': 'food, solid food', 'isthing': 1},
    {'name': 'step, stair', 'isthing': 1},
    {'name': 'trade name', 'isthing': 1},
    {'name': 'pot', 'isthing': 1},
    {'name': 'animal', 'isthing': 1},
    {'name': 'dishwasher', 'isthing': 1},
    {'name': 'screen', 'isthing': 1},
    {'name': 'sculpture', 'isthing': 1},
    {'name': 'hood, exhaust hood', 'isthing': 1},
    {'name': 'sconce', 'isthing': 1},
    {'name': 'tray', 'isthing': 1},
    ...
    {'name': 'fan', 'isthing': 1},
    {'name': 'plate', 'isthing': 1},
    {'name': 'monitor', 'isthing': 1},
    {'name': 'bulletin board', 'isthing': 1},
    {'name': 'radiator', 'isthing': 1},
    {'name': 'glass, drinking glass', 'isthing': 1},
    {'name': 'flag', 'isthing': 1},
    {'name': 'banner', 'isthing': 0},
...
ADE20K_150_CATEGORIES = [
    ...
    # {"color": [255, 0, 122], "id": 126, "isthing": 1, "name": "pigeon"},
